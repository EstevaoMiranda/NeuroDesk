...
export default function Sidebar({ userName = 'Usuário', userEmail = '', userRole = '' }: SidebarProps) {
    ...
    <aside className="w-64 bg-sidebar flex flex-col h-screen sticky top-0 flex-shrink-0">
      ...
      <div className="p-5 border-b border-sidebar-border">
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="text-white font-bold text-lg leading-none">NeuroDesk</span>
            <p className="text-indigo-300 text-xs">CRM Clínico</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-sidebar-border">
        ...
        <button
          ...
          className="w-full flex items-center gap-2 px-3 py-2 text-indigo-300 hover:text-white hover:bg-white/10 rounded-lg transition-colors text-sm"
        >
